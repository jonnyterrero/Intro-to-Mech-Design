 ...
 * - At/Above 4V: Red and Blue LEDs alternate flashing, Yellow LED stays ON
...
void loop() {
  ...
  if (potValue < VOLTAGE_THRESHOLD) {
    ...
    Serial.println(" flashing, Yellow ON");
  }
